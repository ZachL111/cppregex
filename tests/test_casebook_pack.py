"""Regression checks for the cppregex casebook."""
...
from casebook.harness import assert_expected, cppregex_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cppregex_summary(), assert_expected())
