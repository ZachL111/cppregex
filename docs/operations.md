...
`cppregex` is centered on algorithms work in C++. The technical target is: Compile a regex subset into Thompson NFA transitions.
...
The score is deterministic. The current threshold is 167. Risk has a penalty of 5, latency has a penalty of 4, and weight contributes a bonus of 2.
